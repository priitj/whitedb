...
gcc  -O2 -Wall -march=pentium4 -lm -o Main/wgdb Main/wgdb.c Db/dbmem.c \
  ...
  Db/dbjson.c Db/dbschema.c json/JSON_parser.c
gcc  -O2 -march=pentium4 -lm -o Main/indextool  Main/indextool.c Db/dbmem.c \
...
gcc  -O3 -Wall -march=pentium4 -pthread -lm -o Main/stresstest Main/stresstest.c \
  Db/dbmem.c Db/dballoc.c Db/dbdata.c Db/dblock.c Db/dbindex.c Db/dbtest.c  \
  Db/dblog.c Db/dbhash.c Db/dbcompare.c Db/dbquery.c Db/dbutil.c Db/dbmpool.c
